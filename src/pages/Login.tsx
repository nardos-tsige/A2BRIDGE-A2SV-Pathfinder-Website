    ...
    <div className="min-h-[calc(100vh-4rem)] flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-[#f5f0eb] dark:bg-slate-950 transition-colors">
      ...
      >
        <div className="bg-[#eae1d8] dark:bg-slate-900 py-10 px-6 shadow-xl shadow-slate-200/20 dark:shadow-none sm:rounded-3xl sm:px-12 border border-[#dfd4c9] dark:border-slate-800">
          ...
          {error && (
            <div className={cn(
              "mb-4 p-3 border rounded-xl text-sm text-center",
              error.includes("sent") 
            ...
            <form onSubmit={handleForgotPassword} className="space-y-5">
              ...
              <div className="text-center mt-4">
                <button
                  ...
                  className="text-sm font-bold text-[#8c6b54] hover:text-[#6b4c3a] dark:text-purple-400 dark:hover:text-purple-300"
                >
                  Back to Sign In
                </button>
              </div>
              ...
              <div className="flex items-center justify-between mb-1.5">
                ...
                {isLogin && (
                  <button 
                    ...
                    className="text-sm font-medium text-[#8c6b54] hover:text-[#6b4c3a] dark:text-purple-400 dark:hover:text-purple-300"
                  >
                    Forgot password?
                  </button>
                )}
